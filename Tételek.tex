...
\section{Kör és egyenlete}
	...
	\end{definition}
	\begin{definition}
		A kört megkapjuk, ha egy egyenes körkúpot alaplapjával párhuzamos síkkal elmetszünk.
	\end{definition}
	\begin{theorem}
...
\section{Parabola és egyenletei}
	...
	\begin{definition}
		A parabolát megkapjuk, ha egy egyenes körkúpot egy olyan síkkal elmetszünk, amely csak a kúp egyik alkotójával párhuzamos.
	\end{definition}
	\begin{figure}[H]
		\centering
